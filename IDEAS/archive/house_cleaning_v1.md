...
- В коде уже есть:
  - раздел «Дом» с планом по дому, регуляркой и быстрыми сценариями;
  - режим «Уборка сейчас» с выбором типа уборки и уровня сил;
  - очки и стрики за бытовые дела.
- В ближайших спринтах добиваем:
  - более мягкие тексты и отчёты по сценариям;
  - удобную навигацию между «Дом», «План по дому» и «Дела по дому».
 - Implemented in: sprint2.5 (дом/регулярка), sprint3 (тональность и today), sprint5 (уборка сейчас, бытовая химия, режимы).
...
- [ ] Пока нет явного сохранения большого сценария уборки на несколько дней (есть быстрые и «уборка сейчас», но без длинной истории прогресса).
- [ ] Зоны и регулярка ещё не привязаны к общему household (все задачи привязаны к одному пользователю).
- [ ] Нет отдельного отчёта «как менялся дом за неделю/месяц», только очки и стрик.
